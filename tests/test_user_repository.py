...
def test_get_all_users(db_connection):
    ...
    assert repo.get_all() == [
        User(1, 'Jody', 'jodesnode', 'Pass123!', datetime.date(1993, 8, 6), 'calm'),
        User(2, 'Sam', 'sammy1890', 'Word234*', datetime.date(1999, 2, 27), 'excited'),
        User(3, 'Johnson', 'son_of_john', 'Never00!', datetime.date(1995, 10, 19), 'angry'),
        User(4, 'Alice', 'mousey_14', 'Chitchat981!', datetime.date(1982, 5, 31), 'content'),
        User(5, 'Rose', 'rosy_red', 'gatheR&45', datetime.date(1993, 5, 15), 'calm')
    ]
...
def test_find_by_id(db_connection):
    ...
    assert repo.find_by_id(4) == User(4, 'Alice', 'mousey_14', 'Chitchat981!',
                                    datetime.date(1982, 5, 31), 'content')
...
def test_find_by_user_name(db_connection):
    ...
    assert repo.find_by_user_name('son_of_john') == User(3, 'Johnson', 'son_of_john', 'Never00!',
                                                        datetime.date(1995, 10, 19), 'angry')
...
def test_update_user(db_connection):
    ...
    assert repo.get_all() == [
        User(1, 'Jody', 'jodesnode', 'Mental*>@15', datetime.date(1993, 8, 6), 'calm'),
        User(2, 'Sam', 'sammy1890', 'Word234*', datetime.date(1999, 2, 27), 'excited'),
        User(3, 'Johnson', 'son_of_john', 'br@Ker21', datetime.date(1995, 10, 19), 'angry'),
        User(4, 'Alice', 'mousey_14', 'Chitchat981!', datetime.date(1982, 5, 31), 'calm'),
        User(5, 'Rose', 'rosy_red', 'gatheR&45', datetime.date(1993, 5, 15), 'calm')
    ]
